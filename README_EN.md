...
**Release `0.18.3`, based on EXT5, is being prepared.** Publication follows
...
Version 0.18.3 also adds **Mihomo configuration export**, an **experimental HEV profile
...
## First use of version 0.18.3

These steps describe the prepared 0.18.3 release. Refer to the published stable
...
2. Use the wizard to choose devices, services, available methods and sources.
   A fresh 0.18.3 catalog contains six NFQWS2 groups; add other services separately.

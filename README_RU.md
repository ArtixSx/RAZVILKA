...
> Текущий статус: **v0.0.8-security-gate / Safe Mode**. Изменяющие запросы защищены локальным токеном администратора; активные изменения firewall/DNS/policy routing пока заблокированы. Config Center, черновики, валидация, диагностика и текущие HTTP-пробы работают.

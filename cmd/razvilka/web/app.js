  ...
  try {
    ...
    const message = committed
      ...
      : response.not_started === true
        ? 'Импорт не начат: система занята другой операцией или запрос отменён. Настройки не изменены. После завершения текущей операции выберите и проверьте архив заново.'

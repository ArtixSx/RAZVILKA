> **Локальный кандидат UI2 / A1, не релиз.** Единый новый интерфейс, состав изменений и границы проверки: [CANDIDATE_UI2_RU.md](CANDIDATE_UI2_RU.md). Установочный бинарник UI2 не собран.

> **Локальный кандидат Autonomy A1 (`0.18.2-dev`). Не установочный релиз.** Полный backend не собран и не проверен на роутере. [Состав, результаты и ограничения A1](docs/AUTONOMY_A1_RU.md). Дальнейшее описание и исторические результаты относятся к базе rc.2.

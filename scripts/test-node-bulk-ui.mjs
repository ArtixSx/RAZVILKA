...
function fixture({capability=true,confirm=true,lostReply=false}={}){
 ...
 const state={nodes:{nodes,generation:12},services:[{id:'telegram',name:'Telegram'}]},workflowState={bulkBusy:false,epoch:0};
 const nodeBrowser={job:null,source:'invisible-filter',visible:['n1'],page:3};
 let job=null,confirmHook=null;
 const ctx={state,workflowState,nodeBrowser,console,URL,Number,Set,Error,document:{},nodeCanCheck:n=>!!n&&!n.disabled&&n.state!=='expired',
  ...
  workflowRequest:async(path,options={})=>{
   ...
   if(path==='/api/v1/node-checks/current')return {all_vless:capability,job};

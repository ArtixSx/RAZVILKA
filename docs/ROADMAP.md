...
Текущая линия — **`0.18.2-rc.6`**, исправление панели DC1. Канонический подробный
...
Официальный rc.5 прошёл полный CI и сборку для четырёх архитектур. На Netcraze
ARM64 подтверждены обновление, штатный перезапуск, вход с сохранённой учётной
записью, загрузка 16 сервисов и полных настроек NFQWS2 без изменения исходного
файла. Два свежих HTTPS-запроса Telegram прошли через TUN.
[Отчёт и ограничения rc.5](releases/0.18.2-rc.5-validation.md).

Исторический rc.4 прошёл CI, обновление через SSH, перезапуск приложения
...
версии/хэши относятся к своему срезу и не описывают готовность текущей сборки.

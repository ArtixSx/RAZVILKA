...
Ближайшая проверка rc.4 — фактический путь свежих клиентских соединений
при наличии раннего маркированного правила Keenetic и без него. Немаркированный
TUN-путь rc.3 подтверждён, но условный конфликт с прежним VPN остаётся причиной
нового кандидата. Нужны проверка схемы приоритетов `60–69`, точная очистка
старых собственных правил, отказ при чужих конфликтах и текущий runtime
для статуса. CI и аппаратная приёмка rc.4 ещё не подтверждены.

...
**`0.18.2-rc.5`**, исправление панели DC1; стабильный канал — `v0.18.0`.
...
Ближайший выпуск rc.5 устраняет пустой редактор и зависание списка сервисов
при больших подписках. Требуются полный CI, установка официальной сборки,
вход по сохранённому паролю и проверка настоящих форм NFQWS2 и сервисов.
[Изменения](releases/0.18.2-rc.5.md). История rc.4 ниже сохраняется отдельно.

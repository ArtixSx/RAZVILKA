...
> Этот исторический срез заменён аудитом
> [ARCHITECTURE_GAP_2026-08-28.md](ARCHITECTURE_GAP_2026-08-28.md). Он сохранён,
> чтобы не терять основания уже принятых решений.

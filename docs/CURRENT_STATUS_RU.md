...
на синтетических файлах. Модуль ещё не подключён к App и startup; нужны адаптеры
хранилищ, общее владение изменениями и Linux/HIL. Рабочий импорт пока не получил

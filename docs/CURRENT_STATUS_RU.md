...
ещё не подключён; каталог, устройства, staging/provider и HIL остаются.
...
на синтетических файлах. Модуль ещё не подключён к App и startup; нужны остальные
адаптеры хранилищ, общее владение изменениями и Linux/HIL. Рабочий импорт пока не получил

...
[ROADMAP_2026-08-30_RU.md](ROADMAP_2026-08-30_RU.md). Ближайший gate — завершить
правду о версиях и документации, затем убрать ложноположительные Evidence до
расширения любой автоматики.
